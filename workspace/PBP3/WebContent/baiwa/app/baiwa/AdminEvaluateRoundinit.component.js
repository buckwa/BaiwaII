...
var AdminEvaluateRoundinit = (function () {
    function AdminEvaluateRoundinit() {
    }
    AdminEvaluateRoundinit.prototype.ngOnInit = function () {
    };
    AdminEvaluateRoundinit.prototype.adminFacultyeditSucess = function (response) {
    };
    AdminEvaluateRoundinit.prototype.adminFacultyeditError = function (error) {
    };
