...
var AdminAcademicKPI = (function () {
    function AdminAcademicKPI() {
    }
    AdminAcademicKPI.prototype.ngOnInit = function () {
    };
    AdminAcademicKPI.prototype.adminFacultyeditSucess = function (response) {
    };
    AdminAcademicKPI.prototype.adminFacultyeditError = function (error) {
    };
