...
var InitApporve = (function () {
    ...
    InitApporve.prototype.GetPersonByAcadamy = function (user, year) {
        var _this = this;
    ...
    InitApporve.prototype.GetPersonSucess = function (response) {
        this.profile = response.json(JSON.stringify(response._body));
        this.initTotle();
    };
    InitApporve.prototype.GetPersonError = function (error) {
        console.log("GetPersonError.");
    };
